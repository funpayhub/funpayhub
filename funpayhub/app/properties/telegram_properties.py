    ...
    def __init__(self) -> None:
        ...
        self.show_if_mine_only = self.attach_node(
            ToggleParameter(
                ...
                description=_(
                    'Присылать ли уведомление о новых сообщениях в чате, если все новые сообщения отправлены вами через FunPay (не через FunPay Hub!)'
                ),
                default_value=False,
            ),
        )
        ...
        self.show_automatic = self.attach_node(
            ToggleParameter(
                ...
                description=_(
                    'Отображать ли сообщения, отправленные FunPay Hub в автоматическом режиме (автовыдача / автоответ / хуки / плагины и т.д.)'
                ),
                default_value=True,
            ),
        )
        ...
        self.show_automatic_only = self.attach_node(
            ToggleParameter(
                ...
                description=_(
                    'Присылать ли уведомление о новых сообщениях в чате, если все новые сообщения отправлены FunPay Hub в автоматическом режиме (автовыдача / автоответ / хуки / плагины и т.д.)'
                ),
                default_value=True,
            ),
        )
        ...
        self.show_mine_from_hub = self.attach_node(
            ToggleParameter(
                ...
                description=_(
                    'Отображать ли сообщения, которые были отправлены вами с помощью FunPay Hub (через Telegram меню ответа на сообщения и т.д.)'
                ),
                default_value=False,
            ),
        )
        ...
        self.show_mine_from_hub_only = self.attach_node(
            ToggleParameter(
                ...
                description=_(
                    'Присылать ли уведомление о новых сообщениях в чате, если все новые сообщения отправлены вами через Hub (через Telegram меню ответа на сообщения и т.д.)'
                ),
                default_value=False,
            ),
        )
