...
from funpayhub.app.setup import TELEGRAM_SETUP_ROUTERS
...
class Telegram:
    def __init__(
        ...
        self._app = app
        self._commands_registry = CommandsRegistry()
        ...
        self._ui_registry = UIRegistry(workflow_data=workflow_data)
