...
class PropertiesMenuOverride:
    ...
    header_builder: Callable[[Properties, int, int], InlineKeyboardMarkup] = props_menu_header_builder
    footer_builder: Callable[[Properties, int, int], InlineKeyboardMarkup] = props_footer_builder
